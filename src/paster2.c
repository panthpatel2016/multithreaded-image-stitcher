// AI Aknowledgement --> There was some small instances of AI used to help with sync of producer-consumer processes
// [1] Text generated by Claude, Anthropic, October 26, 2025, https://claude.ai/
...
void consumer_process(shared_data_t *shm, int X)
{
    while (1)
    {
        ...
        if (shm->count == 0)
        {
            ...
            {
                sem_post(&shm->mutex);
                sem_post(&shm->filled); // This was added with help of AI to make sure the algorithm works!
                break;
            }
            else
            {
