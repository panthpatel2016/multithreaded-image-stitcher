...
chunk_p get_chunk(FILE *fp); //// helper function created for easy access to get a certain chunk
...
void check_crc(const char *name, chunk_p c); //helper function to check and print crc errors
